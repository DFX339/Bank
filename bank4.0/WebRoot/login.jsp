	...
	<div class="net">
		<div class="nav">
			...
			<ul>
				...
				<li>信用卡</li>
				<li>帮助</li>
				<li class="lastchild"><a href="login.jsp"> <bean:message key="user.show.name"/></a></li>
			</ul>
		</div>
		<div class="lunbo">
			<ul class='mainMenu'>
				<li>
					<span class="first"><a href="login.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px"><bean:message key="user.show.name"/></a></span><br/><br/>
					 <form action="login.do" method="post" onsubmit="return check()">
				<h2>
    			<label class="lab" ><bean:message key="user.show.username"/>：&nbsp;&nbsp;</label> 
    			...
    			<label class="lab"><bean:message key="user.show.password"/>&nbsp;&nbsp;：&nbsp;&nbsp;&nbsp;&nbsp;</label><input id="password" type="password" name="password" onfocus="pwFocus()" onblur="pwBlur()" style="font-size:16px; height:32px;width:160px"/>
    			<span id="pwMsg" class="msg"></span><br/><br/>
    			
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="sub"><input  type="submit" name="login" value="<bean:message key="user.show.button.login"/>" class="msg2"/></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				
				<span class="sub"><input type="button" name="regist" value="<bean:message key="user.show.button.regist"/>" onclick="check1()"class="msg2"/> </span>
				</h2>
  			  </form>
