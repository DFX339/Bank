	...
	<div class="net">
		<div class="nav">
			...
			<ul>
				...
				<li>信用卡</li>
				<li>帮助</li>
				<li class="lastchild"><a href="toLogin.do"><bean:message key="user.show.name"/></a></li>
			</ul>
		</div>
		<div class="lunbo">
			<ul class='mainMenu2'>
				<li>
					<span class="first"><a href="toLogin.do"><bean:message key="user.show.name"/></a></span><br/>
					
				</li>
				<li>
					<span class="first"><a href="toChangeLanguage.do?lang=zh"><bean:message key="user.languaue.chinese"/></a></span><br/>
					<span class="first"><a href="toChangeLanguage.do?lang=en"><bean:message key="user.languaue.english"/></a></span><br/>
