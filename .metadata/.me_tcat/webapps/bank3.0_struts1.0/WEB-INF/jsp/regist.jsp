	...
	<div class="net">
		<div class="nav">
			...
			<ul>
				...
				<li>信用卡</li>
				<li>帮助</li>
				<li class="lastchild"><a href="login.jsp">登录</a></li>
			</ul>
		</div>
		<div class="lunbo">
			<ul class='mainMenu'>
				<li>
					<span class="first"><a href="regist.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px">用户注册</a></span><br/><br/>
					  <form id="form" name="form" action="regist.do" method="post" onsubmit="return check()">
					  <h3>
 			 用   户  名：<input type="text" name="username" id="username" onfocus="nameFocus()" onblur="nameBlur()" style="font-size:16px;height:32px;width:160px "/>
 			 		 <span id="nameMsg" class="msg"></span><br><br>
 			 密&nbsp;&nbsp;码：<input type="password" name="password" id="password" onfocus="pwFocus()" onblur="pwBlur()" style="font-size:16px;height:32px;width:160px "/>
 			 			<span id="pwMsg" class="msg"></span><br><br>
 			 预存金额：<input type="text" name="money" value="0.0" id="money" onfocus="moneyFocus()" onblur="moneyBlur()" style="font-size:16px;height:32px;width:160px "/>
 			 		<span id="moneyMsg" class="msg"></span><br><br>
 			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 			 <input id="regist" type="submit" value="注册" class="msg2"/>
 		 	</h3>
 		 	</form>
