...
<body>
	<div class="net">
		...
		<div class="lunbo">
			<ul class='mainMenu'>
				<li>
					<span class="first"><a href="login.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px">用户登录</a></span><br/><br/>
    			...
    			<label class="lab">密&nbsp;&nbsp;码：&nbsp;&nbsp;&nbsp;&nbsp;</label><input id="password" type="password" name="password" onfocus="pwFocus()" onblur="pwBlur()" style="font-size:16px; height:32px;width:160px"/>
    			<span id="pwMsg" class="msg"></span><br/><br/>
    			
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="sub"><input  type="submit" name="login" value="登录" class="msg2"/></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				
				<span class="sub"><input type="button" name="regist" value="注册" onclick="check1()"class="msg2"/> </span>
				</h2>
  			  </form>
