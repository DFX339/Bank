...
<body>
	<div class="net">
		...
		<div class="lunbo">
			<ul class='mainMenu1'>
				<li>
					<span class="first1"><a href="main.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:230px;padding-left:100px"><bean:message key="user.main"/></a></span><br/><br/>
					<h4>
					<html:errors/>
 			<form action="bank.do?command=inqury" method="post">
			  <bean:message key="user.main.username"/>： <input type="text" name="username" value="${user.username }" readonly="true" style="font-size:16px;width:200;height:32"/>
 			<input type="submit" name="inqury" value="<bean:message key="user.main.button.inqury"/>" class="msg2"/>
 			</form> <br/>
 			
 			<form action="bank.do?command=deposit" method="post">
 				<bean:message key="user.main.store"/>：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>
 			 	<input type="submit" name="deposit" value="<bean:message key="user.main.button.store"/>"  class="msg2"/>
 			 </form> <br/>
 			 
 			 <form action="bank.do?command=withdrawal" method="post">
 				<bean:message key="user.main.withdrawal"/>：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>
 			 	<input type="submit" name="withdrawal" value="<bean:message key="user.main.button.withdrawal"/>"  class="msg2"/>
 			 </form><br/><hr><br>
 			
 			<form action="bank.do?command=transfer" method="post">
 				<bean:message key="user.main.transferID"/>：<input type="text" name="objId" style="font-size:16px;width:200;height:32" /><br><br>
 				<bean:message key="user.main.transferNum"/>：<input type="text" name="money" style="font-size:16px;width:200;height:32"/>&nbsp;&nbsp;&nbsp;
 			 	<input type="submit" name="transfer" value="<bean:message key="user.main.button.transfer"/>"  class="msg2"/>
 		 	</form>
 		 	</h4>
