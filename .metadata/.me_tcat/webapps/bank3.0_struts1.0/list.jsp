...
<body>
	<div class="net">
		...
		<div class="lunbo">
			<ul class='mainMenu1'>
				<li>
					<span class="first1"><a href="main.jsp" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:28px;width:320px;padding-left:100px"><bean:message key="user.list.show.name"/></a></span><br/><br/>
				<h3>
 			<form action="return.do" method="post">
 			 	...
 			 	<br><bean:message key="user.list.show.money"/>：<input type="text" name="money" value="${user.money }" readonly="true" style="font-size:20px;height:32px;width:200px"/><br/><br/><br/>
 			 	<input type="submit" value="<bean:message key="user.list.return"/>" style="color:white;background-color:#99cc33;display:inline-block;border-bottom:1px solid #99cc33;font-size:20px; height:32px;width:200px "/>
 			 </form>
 		 	</h3>
